...
var jumpLayer6 = cc.Layer.extend({
    size:null,
    ctor:function(){
        this._super();
		...
		Global.getInstance().nowscene = new jumpScene6();
		...
		//事件
		Scene_event.getInstance().set_event(this,6,day_num,group_name);
		//状态栏
...
var jumpScene6 = cc.Scene.extend({
    onEnter:function(){
      this._super();
      var layer = new jumpLayer6();
      this.addChild(layer);
    },
})
